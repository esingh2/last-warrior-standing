...
// Scale & project spell art
var spell_w = sprite_get_width(spr_spell1_icon);
var spell_scale = (slot_radius * 1.4) / spell_w;
...
// =========================================================================
var key_y = block_y2 + 14; // Drops down clear beneath the master panel border

var dash_key_text  = "SHIFT";
var spell_key_text = "Q";
...
// Spell Keybind Text
draw_set_color(c_black);  draw_text(spell_x + 1, key_y + 1, spell_key_text);
draw_set_color(c_dkgray); draw_text(spell_x, key_y, spell_key_text);
